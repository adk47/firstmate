...
state/               runtime records and signals; gitignored
  ...
  .primary-endpoint .keepalive-agent.log  this home's own recorded primary terminal endpoint and the opt-in out-of-session keep-alive job's bounded log; written only by bin/fm-keepalive-endpoint.sh and bin/fm-keepalive-agent.sh
