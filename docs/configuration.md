...
FM_SNAPSHOT_LOCAL_READ_CONCURRENCY=8   # maximum local tasks whose current-state, open-decision fold, and endpoint observations are collected concurrently during snapshot composition
